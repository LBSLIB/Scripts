...
If (Test-Path $uninstallKeyPath)
{
    ...
    $Office2019Uninstall = Start-Process "C:\ProgramData\Office_2024_Source\Office_2019_Standard_Uninstall\setup.exe" -ArgumentList "/Configure C:\ProgramData\Office_2024_Source\Office_2019_Standard_Uninstall\Uninstall.xml" -Wait -PassThru
...
If (-not $c2r -or $c2r.ProductReleaseIds -notmatch "2024")
{
    ...
    $Office2024Install = Start-Process "C:\ProgramData\Office_2024_Source\Office_2024_Standard\setup.exe" -ArgumentList "/Configure C:\ProgramData\Office_2024_Source\Office_2024_Standard\Configuration_Office_2024_Standard_x64_LBSLIB.xml" -Wait -PassThru
